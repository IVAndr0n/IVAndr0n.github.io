...
На время закачки подключаем VPN и скачиваем с официального сайта [Grafana](https://grafana.com/grafana/dashboards) необходимый дашборд в формате JSON файла.
